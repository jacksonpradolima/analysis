...
public class GeneratorFactory {
	...
	public static Generator getGenerator(JFrame parent, String generatorName, File[] folders) {
		...
		} else if (generatorName.equalsIgnoreCase(ApproximateTrueParetoFrontGenerator.class.getSimpleName())) {
			return new ApproximateTrueParetoFrontGenerator(parent, folders);
